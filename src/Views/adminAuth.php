...
<body class="min-h-screen">
    ...
    <div class="container mx-auto py-5 px-10 bg-slate-50 flex justify-center admin-auth-container">
        <div class="admin-auth">
            <h3 class="mb-5">Admin authorization</h3>
            <form method="post" action="/admin-authorize" class="flex flex-col">
                ...
                <div class="flex block flex-col w-80 mb-5">
                    ...
                    <input required class="py-2 px-3" type="password" name="password" placeholder="password">
                </div>
